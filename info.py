...
REQ_CHANNEL1=environ.get("REQ_CHANNEL1", "-1002345410171")
...
DATABASE_URI3 = environ.get('DATABASE_URI3', "mongodb+srv://Autofilterv7:Autofilterv7@cluster0.t5tqe4s.mongodb.net/")
